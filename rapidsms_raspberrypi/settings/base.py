# Django settings for rapidsms_raspberrypi project.
import os
...
SECRET_KEY = '8@_^u#qg(^fkqt_3@m^3ufz=)7#%x%ohk$1*jqrq87ci_a67yv'
...
ROOT_URLCONF = 'rapidsms_raspberrypi.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'rapidsms_raspberrypi.wsgi.application'
